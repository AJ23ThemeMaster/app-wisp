                ...
                if($id_usuario){
                    ...
                    if ($err) {
                        ...
                        if (isset($response['error'])) {
                            ...
                            <img src="https://app.istingenieria.online/images/logo.png" alt="" width="300" style="height:auto;display:block;" />
                            </td>
                            </tr>
                            <tr>
                            ...
                            <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;color: #b00606;">
                            '.$codigo.'
                            </h1>
                            <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;text-align: justify;">
                            ...
                            <tr>
                            <td style="padding:30px;background:#b00606;">
